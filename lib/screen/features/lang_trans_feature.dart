...
class _TranslatorFeatureState extends State<TranslatorFeature> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        padding: EdgeInsets.only(top: Get.height * .02, bottom: Get.height * .1),
        children: [
          ...
          Padding(
            padding: EdgeInsets.symmetric(
                horizontal: Get.width * .04, vertical: Get.height * .035),
            child: TextFormField(
              controller: _c.textC,
              minLines: 5,
              maxLines: null,
  ...
  Widget _translateResult() => switch (_c.status.value) {
    ...
    Status.error => const Align(child: Text('Something went wrong!')),
      };
}
